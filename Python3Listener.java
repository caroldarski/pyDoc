...
public interface Python3Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#comment_stmt}.
	 * @param ctx the parse tree
	 */
	void enterComment_stmt(Python3Parser.Comment_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#comment_stmt}.
	 * @param ctx the parse tree
	 */
	void exitComment_stmt(Python3Parser.Comment_stmtContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#commentdef}.
	 * @param ctx the parse tree
	 */
	void enterCommentdef(Python3Parser.CommentdefContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#commentdef}.
	 * @param ctx the parse tree
	 */
